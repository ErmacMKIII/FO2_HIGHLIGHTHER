 ...
 */
public class FO2HLogger {

    private static final Logger MY_LOGGER = Logger.getLogger(FO2HLogger.class.getName());
    ...
    public static void init(boolean debug) { // adding console and log file to the logger
        ...
        if (debug) { // if debug it's gonna store messages in both console and the file otherwise just in the file
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(FO2HLogger.class.getName()).log(Level.SEVERE, null, ex);
            }
