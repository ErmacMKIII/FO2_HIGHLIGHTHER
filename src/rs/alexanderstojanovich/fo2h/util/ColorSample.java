 ...
 */
public class ColorSample { // used primarily for drawing outline in Work
     ...
     *
     * @param wr Writable raster (must be RGBA)
     * @param px pixel x coordinate
     * @param py pixel y coordinate
     * @param offset corresponds to outline width
    ...
    /**
     * Gets alpha of this color sample (used for special effects)
     *
     * @return alpha of this color sample
     */
    public int getAlpha() {
        return alpha;
    }
